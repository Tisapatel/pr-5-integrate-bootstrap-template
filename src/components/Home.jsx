            ...
            <div className="row g-0 align-items-center">
              <div className="col-lg-6 hero-header-text py-5">
                <div className="py-5 px-3 ps-lg-0">
                  <h1 className="font-dancing-script text-primary animated slideInLeft">
                    Welcome
                  </h1>
                  <h1 className="display-1 mb-4 animated slideInLeft">
          ...
          <div className="row g-0">
            <div className="col-md-6">
              <div className="d-flex align-items-center h-100 bg-primary p-5">
                <div className="wow fadeIn" data-wow-delay="0.3s">
                  ...
                  <h1
                    className="display-1 text-uppercase mb-5"
                  ...
                  <div className="row g-4 align-items-center">
                    <div className="col-lg-6">
                      <div className="text-center bg-dark p-5">
                        ...
                        <h1 className="display-1 font-work-sans text-white">
                          20%
                        </h1>
                    ...
                    <div className="col-lg-6">
                      <p>
                        ...
                        Maecenas eget libero lobortis, auctor nisi quis, aliquet
                        nunc. Nam dapibus lacus.
                      </p>
            ...
            <div className="col-md-6">
              <div className="h-100 bg-dark p-5">
                <div
                  className="price-item mb-3 wow fadeIn"
                  data-wow-delay="0.1s"
                >
                  <img
                ...
                <div className="team-item position-relative overflow-hidden">
                  ...
                  <div className="team-overlay">
                    ...
                    <div className="d-flex justify-content-center">
                      <a
                        className="btn btn-dark btn-sm-square border-2 me-3"
                        href
                      >
          ...
          <div className="row g-0">
            <div className="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
              <div className="h-100 d-flex flex-column justify-content-center bg-primary py-5 px-4">
                <p className="mb-2">
                  <i className="fa fa-calendar-alt text-dark me-1" />
                  Jan 01, 2045 |{" "}
                  <i className="fa fa-folder-open text-dark me-1" />
                  Hair Salon
                </p>
                <h3 className="mb-3">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Maecenas eget libero lobortis, auctor nisi quis, aliquet nunc.
                  Nam dapibus interdum lacus.
                </p>
                <a
                  className="btn btn-dark align-self-start text-uppercase"
                  href
                >
                  Read More <i className="bi bi-arrow-right" />
                </a>
